...
export function ProductsHeroSection() {
  ...
  const textY = useTransform(scrollYProgress, [0, 1], [0, 200]); // Text moves down
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10  px-8 max-w-4xl "
      >
        {/* Heading */}
        <h1 className="text-5xl md:text-[60px] font-bold text-white mb-6 leading-tight">
        ...
        <div className="overflow-hidden max-h-32">
          <motion.p
            ...
            className="text-xl md:text-[20px] text-white/90 max-w-3xl mb-1 leading-relaxed"
          >
